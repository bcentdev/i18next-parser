...
var HandlebarsLexer = /*#__PURE__*/ (function (_BaseLexer) {
  _inherits(HandlebarsLexer, _BaseLexer)
  var _super = _createSuper(HandlebarsLexer)
  function HandlebarsLexer() {
    var _this
    var options =
      arguments.length > 0 && arguments[0] !== undefined ? arguments[0] : {}
    _classCallCheck(this, HandlebarsLexer)
  ...
  _createClass(HandlebarsLexer, [
    ...
    {
      key: 'populateKeysFromArguments',
      value: function populateKeysFromArguments(args) {
        ...
        if (!isKeyString) {
          this.emit(
            'warning',
            'Key is not a string literal: '.concat(firstArgument)
          )
        } else {
    ...
    {
      key: 'createFunctionRegex',
      value: function createFunctionRegex() {
    ...
    {
      key: 'createArgumentsRegex',
      value: function createArgumentsRegex() {
        var pattern =
          '(?:\\s+|^)' +
          '(' +
          '(?:' +
...
export { HandlebarsLexer as default }
