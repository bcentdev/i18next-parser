...
var HTMLLexer = /*#__PURE__*/ (function (_BaseLexer) {
  _inherits(HTMLLexer, _BaseLexer)
  var _super = _createSuper(HTMLLexer)
  function HTMLLexer() {
    var _this
    var options =
      arguments.length > 0 && arguments[0] !== undefined ? arguments[0] : {}
    _classCallCheck(this, HTMLLexer)
        ...
        $('['.concat(that.attr, ']')).each(function (index, node) {
          ...
          try {
            for (_iterator.s(); !(_step = _iterator.n()).done; ) {
              ...
              if (key) {
                _this2.keys.push(
                  _objectSpread(_objectSpread({}, options), {}, { key: key })
                )
              }
            }
          } catch (err) {
